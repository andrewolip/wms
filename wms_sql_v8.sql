...
CREATE TABLE IF NOT EXISTS `wms_db`.`fornecedor` (
  ...
  `contato` VARCHAR(100) NULL DEFAULT NULL COMMENT '',
  `email` VARCHAR(100) NULL DEFAULT NULL COMMENT '',
  `descricao` VARCHAR(255) NULL DEFAULT NULL COMMENT '',
  `cep` VARCHAR(45) NULL DEFAULT NULL COMMENT '',
  `logradouro` VARCHAR(255) NULL DEFAULT NULL COMMENT '',
  `numero` VARCHAR(15) NULL DEFAULT NULL COMMENT '',
  `bairro` VARCHAR(100) NULL DEFAULT NULL COMMENT '',
  `complemento` VARCHAR(100) NULL DEFAULT NULL COMMENT '',
  `cidade` VARCHAR(100) NULL DEFAULT NULL COMMENT '',
  `estado` VARCHAR(2) NULL DEFAULT NULL COMMENT '',
  `ativo` TINYINT(4) NOT NULL DEFAULT '1' COMMENT '',
...
CREATE TABLE IF NOT EXISTS `wms_db`.`conta_pagar` (
  ...
  `nota_fiscal` VARCHAR(45) NULL DEFAULT NULL COMMENT '',
  `valor_conta` DECIMAL(10,0) NULL DEFAULT NULL COMMENT '',
  `data_vencimento` DATE NULL DEFAULT NULL COMMENT '',
  `data_pagamento` DATE NULL DEFAULT NULL COMMENT '',
  `tipo_pagamento` INT(11) NULL DEFAULT NULL COMMENT '',
  `tipo_conta` INT(11) NULL DEFAULT NULL COMMENT '',
...
CREATE TABLE IF NOT EXISTS `wms_db`.`conta_bancaria` (
  ...
  `banco` INT(11) NULL DEFAULT NULL COMMENT '',
  `agencia` VARCHAR(10) NULL DEFAULT NULL COMMENT '',
  `conta_bancaria` VARCHAR(10) NULL DEFAULT NULL COMMENT '',
  `titular` VARCHAR(255) NULL DEFAULT NULL COMMENT '',
...
CREATE TABLE IF NOT EXISTS `wms_db`.`cliente` (
  ...
  `nome_razao_social` VARCHAR(100) NULL DEFAULT NULL COMMENT '',
  `cpf_cnpj` VARCHAR(20) NULL DEFAULT NULL COMMENT '',
...
CREATE TABLE IF NOT EXISTS `wms_db`.`usuario` (
  ...
  `perfil` INT(1) NULL DEFAULT NULL COMMENT '',
...
CREATE TABLE IF NOT EXISTS `wms_db`.`unidade_obra` (
  ...
  `nome_obra` VARCHAR(100) NULL DEFAULT NULL COMMENT '',
  `descricao` VARCHAR(1000) NULL DEFAULT NULL COMMENT '',
...
CREATE TABLE IF NOT EXISTS `wms_db`.`lancamento` (
  ...
  `valor_lancamento` DECIMAL(10,0) NULL DEFAULT NULL COMMENT '',
...
CREATE TABLE IF NOT EXISTS `wms_db`.`anexo` (
  ...
  `nome` VARCHAR(255) NULL DEFAULT NULL COMMENT '',
  `descricao` TEXT NULL DEFAULT NULL COMMENT '',
  `arquivo` BLOB NULL DEFAULT NULL COMMENT '',
...
CREATE TABLE IF NOT EXISTS `wms_db`.`empresa` (
  ...
  `cnpj` VARCHAR(20) NULL DEFAULT NULL COMMENT '',
  `telefone` VARCHAR(20) NULL DEFAULT NULL COMMENT '',
  `contato` VARCHAR(255) NULL DEFAULT NULL COMMENT '',
  `email` VARCHAR(100) NULL DEFAULT NULL COMMENT '',
...
CREATE TABLE IF NOT EXISTS `wms_db`.`colaborador` (
  ...
  `numero_contrato` INT(11) NULL DEFAULT NULL COMMENT '',
...
CREATE TABLE IF NOT EXISTS `wms_db`.`comentario_obra` (
  ...
  `obra_numero_contrato` INT(11) NULL DEFAULT NULL COMMENT '',
  `id_obra` INT(11) NOT NULL COMMENT '',
...
CREATE TABLE IF NOT EXISTS `wms_db`.`fase` (
  ...
  `nome_fase` VARCHAR(45) NULL DEFAULT NULL COMMENT '',
  `descricao` VARCHAR(255) NULL DEFAULT NULL COMMENT '',
...
CREATE TABLE IF NOT EXISTS `wms_db`.`item_conta` (
  ...
  `valor_unitario` DECIMAL(10,2) NULL DEFAULT NULL COMMENT '',
  `id_conta_pagar` INT(11) NOT NULL COMMENT '',
  PRIMARY KEY (`id_item`)  COMMENT '',
  INDEX `fk_item_conta_conta_pagar1_idx` (`id_conta_pagar` ASC)  COMMENT '',
...
CREATE TABLE IF NOT EXISTS `wms_db`.`parcela` (
  ...
  `n_parcela` DECIMAL(10,0) NULL DEFAULT NULL COMMENT '',
  `data_vencimento` DATE NULL DEFAULT NULL COMMENT '',
  `valor_parcela` DECIMAL(10,0) NULL DEFAULT NULL COMMENT '',
...
CREATE TABLE IF NOT EXISTS `wms_db`.`tarefa_obra` (
  ...
  `progresso` DECIMAL(3,2) NULL DEFAULT NULL COMMENT '',
  `observacao` VARCHAR(1000) NULL DEFAULT NULL COMMENT '',
  `status` INT(11) NULL DEFAULT NULL COMMENT '',
  `id_fase` INT(11) NOT NULL COMMENT '',

...
CREATE TABLE IF NOT EXISTS `wms_db`.`obra` (
  ...
  `endereco` VARCHAR(1000) NULL DEFAULT NULL COMMENT '',
  ...
  `custo_previsto` DECIMAL(10,2) NULL DEFAULT NULL COMMENT '',
  `custo_realizado` DECIMAL(10,2) NULL DEFAULT NULL COMMENT '',
...
CREATE TABLE IF NOT EXISTS `wms_db`.`comentario_obra` (
  `id_comentario` INT(11) NOT NULL AUTO_INCREMENT COMMENT '',
  `obra_numero_contrato` INT(11) NULL COMMENT '',
  `id_obra` INT(11) NOT NULL COMMENT '',
  PRIMARY KEY (`id_comentario`)  COMMENT '',
  INDEX `fk_comentario_obra_obra_idx` (`id_obra` ASC)  COMMENT '',
...
CREATE TABLE IF NOT EXISTS `wms_db`.`centro_custo` (
  `id_centro_custo` INT(11) NOT NULL AUTO_INCREMENT COMMENT '',
  `id_obra` INT(11) NULL COMMENT '',
  `descricao` VARCHAR(1000) NULL DEFAULT NULL COMMENT '',
  `saldo_atual` DECIMAL(10,2) NULL DEFAULT NULL COMMENT '',
...
CREATE TABLE IF NOT EXISTS `wms_db`.`categoria_item` (
  `id_categoria_item` INT(11) NOT NULL AUTO_INCREMENT COMMENT '',
...
CREATE TABLE IF NOT EXISTS `wms_db`.`fornecedor` (
  ...
  `contato` VARCHAR(100) NULL COMMENT '',
...
CREATE TABLE IF NOT EXISTS `wms_db`.`subcategoria_item` (
  `id_subcategoria_item` INT(11) NOT NULL AUTO_INCREMENT COMMENT '',
  `nome` VARCHAR(45) NULL COMMENT '',
  `descricao` VARCHAR(45) NULL DEFAULT NULL COMMENT '',
  `id_categoria_item` INT(11) NOT NULL COMMENT '',
...
CREATE TABLE IF NOT EXISTS `wms_db`.`item` (
  ...
  `nome` VARCHAR(45) NULL COMMENT '',
  `descricao` VARCHAR(45) NULL DEFAULT NULL COMMENT '',
  `id_subcategoria_item` INT(11) NOT NULL COMMENT '',
...
CREATE TABLE IF NOT EXISTS `wms_db`.`conta_bancaria` (
  ...
  `banco` INT(11) NULL COMMENT '',
  `agencia` VARCHAR(10) NULL COMMENT '',
  `conta_bancaria` VARCHAR(10) NULL COMMENT '',
  `titular` VARCHAR(255) NULL COMMENT '',
...
CREATE TABLE IF NOT EXISTS `wms_db`.`opcao_pagamento` (
  `id_opcao_pagamento` INT(11) NOT NULL AUTO_INCREMENT COMMENT '',
  `nome` VARCHAR(45) NULL DEFAULT NULL COMMENT '',
  `descricao` VARCHAR(45) NULL DEFAULT NULL COMMENT '',
  `a_vista` TINYINT(1) NULL DEFAULT NULL COMMENT '',
  `parcelado` TINYINT(1) NULL DEFAULT NULL COMMENT '',
...
CREATE TABLE IF NOT EXISTS `wms_db`.`conta_pagar` (
  ...
  `nota_fiscal` VARCHAR(45) NULL COMMENT '',
  `valor_conta` DECIMAL(10,0) NULL COMMENT '',
  `data_vencimento` DATE NULL COMMENT '',
  `data_pagamento` DATE NULL COMMENT '',
  `tipo_pagamento` INT(11) NULL COMMENT '',
  `tipo_conta` INT(11) NULL COMMENT '',
  `observacao` VARCHAR(255) NULL DEFAULT NULL COMMENT '',
...
CREATE TABLE IF NOT EXISTS `wms_db`.`forma_pagamento` (
  `id_dados_pagamento` INT(11) NOT NULL AUTO_INCREMENT COMMENT '',
  `descricao` VARCHAR(255) CHARACTER SET 'big5' COLLATE 'big5_bin' NULL DEFAULT NULL COMMENT '',
  `forma_pagamento` INT(11) NULL DEFAULT NULL COMMENT '',
  `data_desconto_cheque` DATE NULL DEFAULT NULL COMMENT '',
  `valor` DECIMAL(10,2) NULL DEFAULT NULL COMMENT '',
  `num_parcelas` INT(11) NULL DEFAULT NULL COMMENT '',
  `data_emissao_boleto` DATE NULL DEFAULT NULL COMMENT '',
  `data_vencimento_boleto` DATE NULL DEFAULT NULL COMMENT '',
  `dia_vencimento_creditol` INT(11) NULL DEFAULT NULL COMMENT '',
  `dia_fechamento_credito` INT(11) NULL DEFAULT NULL COMMENT '',
  `observacao` VARCHAR(255) NULL DEFAULT NULL COMMENT '',
  `id_conta_bancaria` INT(11) NOT NULL COMMENT '',
  `id_opcao_pagamento` INT(11) NOT NULL COMMENT '',
...
CREATE TABLE IF NOT EXISTS `wms_db`.`cliente` (
  ...
  `nome_razao_social` VARCHAR(100) NULL COMMENT '',
  `cpf_cnpj` VARCHAR(20) NULL COMMENT '',
...
CREATE TABLE IF NOT EXISTS `wms_db`.`unidade_obra` (
  ...
  `nome_obra` VARCHAR(100) NULL COMMENT '',
  `descricao` VARCHAR(1000) NULL DEFAULT NULL COMMENT '',
  ...
  INDEX `fk_unidade_obra_obra1_idx` (`id_obra` ASC)  COMMENT '',
...
CREATE TABLE IF NOT EXISTS `wms_db`.`conta_receber` (
  ...
  `n_parcelas` INT(11) NULL DEFAULT NULL COMMENT '',
  `status` TINYINT(1) NULL COMMENT '',
  `id_dados_pagamento` INT(11) NOT NULL COMMENT '',
...
CREATE TABLE IF NOT EXISTS `wms_db`.`lancamento` (
  ...
  `valor_lancamento` DECIMAL(10,0) NULL COMMENT '',
  `data_lancamento` DATE NULL COMMENT '',
  `observacao` VARCHAR(1000) NULL DEFAULT NULL COMMENT '',
  `id_conta_pagar` INT(11) NULL DEFAULT NULL COMMENT '',
  `id_conta_receber` INT(11) NULL DEFAULT NULL COMMENT '',
  `id_centro_custo` INT(11) NOT NULL COMMENT '',
...
CREATE TABLE IF NOT EXISTS `wms_db`.`anexo` (
  ...
  `id_lancamento` INT(11) NULL DEFAULT NULL COMMENT '',
  `id_unidade_obra` INT(11) NULL DEFAULT NULL COMMENT '',
  `id_obra` INT(11) NULL DEFAULT NULL COMMENT '',
  `id_conta_pagar` INT(11) NULL DEFAULT NULL COMMENT '',
  `id_conta_receber` INT(11) NULL DEFAULT NULL COMMENT '',
...
CREATE TABLE IF NOT EXISTS `wms_db`.`empresa` (
  ...
  `razao_social` VARCHAR(255) NULL COMMENT '',
...
CREATE TABLE IF NOT EXISTS `wms_db`.`fase` (
  ...
  `nome_fase` VARCHAR(45) NULL COMMENT '',
...
CREATE TABLE IF NOT EXISTS `wms_db`.`colaborador` (
  ...
  `numero_contrato` INT(11) NULL COMMENT '',
  ...
  INDEX `fk_colaborador_obra1_idx` (`id_obra` ASC)  COMMENT '',
...
CREATE TABLE IF NOT EXISTS `wms_db`.`parcela` (
  ...
  `n_parcela` DECIMAL(10,0) NULL COMMENT '',
  `data_vencimento` DATE NULL COMMENT '',
  `valor_parcela` DECIMAL(10,0) NULL COMMENT '',
  `status` TINYINT(1) NULL DEFAULT '0' COMMENT '',
  `id_boleto` INT(11) NULL DEFAULT NULL COMMENT '',
  `id_cartao_credito` INT(11) NULL DEFAULT NULL COMMENT '',
  `id_cheque` INT(11) NULL DEFAULT NULL COMMENT '',
  `id_dados_pagamento` INT(11) NOT NULL COMMENT '',
...
CREATE TABLE IF NOT EXISTS `wms_db`.`tarefa_obra` (
  ...
  `progresso` DECIMAL(3,2) NULL COMMENT '',
  `observacao` VARCHAR(1000) NULL DEFAULT NULL COMMENT '',
  `status` INT(11) NULL COMMENT '',
  `id_fase` INT(11) NOT NULL COMMENT '',
...
-- -----------------------------------------------------
-- Table `wms_db`.`item_conta`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `wms_db`.`item_conta` (
  ...
  PRIMARY KEY (`id_item`),
  KEY `fk_item_conta_conta_pagar1_idx` (`id_conta_pagar`),
    CONSTRAINT `fk_item_conta_conta_pagar1` 
      FOREIGN KEY (`id_conta_pagar`) 
